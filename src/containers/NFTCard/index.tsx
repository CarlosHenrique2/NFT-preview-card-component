    ...
    <div className="nftCard">
      ...
      <div className="nftCard__inforContainer">
        <div className="nftCard__inforContainer__priceContainer">
          ...
          <p className="nftCard__inforContainer__priceContainer__label">
            {price} ETH
          </p>
        </div>
        <div className="nftCard__inforContainer__timeConteiner">
          <img src={iconClock} alt="iconClock" />
          <p className="nftCard__inforContainer__timeConteiner__label">
            {days} days left
          </p>
        </div>
      </div>
      ...
      <div className="nftCard__avatarContainer">
        <div className="nftCard__avatarContainer__avatarImage">
          <img
            className="nftCard__avatarContainer__avatar"
            src={avatar}
            alt="avatar"
          />
        </div>
        <p className="nftCard__avatarContainer__paragraph">
          Creation of{" "}
          <span className="nftCard__avatarContainer__span">{creator}</span>
        </p>
      </div>
    </div>
  );
